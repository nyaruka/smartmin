...
class Post(SmartModel):
    title = models.CharField(max_length=128, help_text="The title of this blog post, keep it relevant")
    ...
    tags = models.CharField(max_length=128, help_text="Any tags for this post")
    ...
    image = models.ImageField(
        upload_to="images", null=True, blank=True, help_text="The logo that should be used for this post"
    )
...
class Category(SmartModel):
    name = models.SlugField(max_length=64, unique=True, help_text="The name of this category")
